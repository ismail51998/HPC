...
int64_t bind_c_solve_2d_nonlinearconv_pyccel(int64_t n0_u, int64_t n1_u, double *u, int64_t n0_un, int64_t n1_un, double *un, int64_t n0_v, int64_t n1_v, double *v, int64_t n0_vn, int64_t n1_vn, double *vn, int64_t nt, double dt, double dx, double dy, double c);
...
PyObject *solve_2d_nonlinearconv_pyccel_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (PyArray_IsScalar(c_tmp, Float64))
    {
        PyArray_ScalarAsCtype(c_tmp, &c);
    }
    else if (PyFloat_Check(c_tmp))
    {
        c = PyFloat_AsDouble(c_tmp);
    }
    else
    {
        PyErr_SetString(PyExc_TypeError, "\"c must be 64 bit real\"");
        return NULL;
    }
...
static PyMethodDef mod_yj49750w464a_yj49750w464a_methods[] = {
    {
...
static struct PyModuleDef mod_yj49750w464a_yj49750w464a_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_yj49750w464a_yj49750w464a",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    -1,
    mod_yj49750w464a_yj49750w464a_methods
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_yj49750w464a_yj49750w464a(void)
{
    PyObject *m;
    import_array();
    m = PyModule_Create(&mod_yj49750w464a_yj49750w464a_module);
